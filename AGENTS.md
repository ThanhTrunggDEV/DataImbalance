...
## Common Commands
- **Full Run (KOA)**: `cd src && python run_all.py`
- **Full Run (EyePACS)**: `cd src && python run_all.py --data_dir ../data_dr --num_workers 4`
...
- **Top 6 × 2 seeds (EyePACS, Linux server)**: `cd src && python run_all.py --data_dir ../data_dr --num_workers 4 --only v1_baseline v3_balanced_softmax v5_focal_loss v7_adjacent_balanced v11_owmixup_ce v12_owmixup_balanced_t20 --seeds 42 123`
