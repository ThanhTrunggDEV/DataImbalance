...
\textbf{Temperature sensitivity.} Fig.~\ref{fig:koa_curves} compares training dynamics on KOA. OWMixup configurations converge stably across temperatures, with $\tau=2.0$ (CE) achieving the fastest convergence on KOA while $\tau=0.5$ (BalSoft) provides better EyePACS generalization.
