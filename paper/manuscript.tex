...
Fig.~\ref{fig:koa_heatmap} visualizes the per-class F1 heatmap, clearly showing how ordinal-aware methods (v7, v11, v12) elevate the darker low-F1 regions of Grade~1 relative to the baseline.

\begin{figure}[h!]
\centering
\includegraphics[width=0.85\linewidth]{fig1_heatmap_KOA.png}
\caption{Per-class F1 heatmap on KOA. Ordinal-aware methods (v7, v11, v12) elevate minority-class F1 (G1, G4) while maintaining majority-class performance.}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.85\linewidth]{fig1_heatmap_eyepacs.png}
\caption{Per-class F1 heatmap on EyePACS DR. Ordinal logit adjustment improves minority DR~1 class across all ordinal-aware methods.}
\label{fig:eyepacs_heatmap}
\end{figure}
